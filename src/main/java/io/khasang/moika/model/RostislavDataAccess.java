...
public interface RostislavDataAccess {
     ...
     * <p>
     * @param leftTableName имя левой сущности БД (таблицы или представления)
     * @param rightTableName имя правой сущности БД (таблицы или представления)
     * @param joinType тип соединения (один из допустимых для данной СУБД, по умолчанию - INNER)
     * @param joiners набор условий соединения в виде коллекции, каждый элемент которой - тройка: "имя левого поля -> пара: оператор, имя правого поля"
